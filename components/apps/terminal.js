...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            projects: ["Lalit-personal-portfolio", "Networking-Projects", "Bash-Scripting-Projects", "Powershell-Scripting"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">lalit@Dell</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/lalit")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-lalit, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-Lalit":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-Lalit");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-Lalit, todoist, trash, settings, sendmsg ]";
                }
                break;
