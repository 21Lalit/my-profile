    ...
    return (
        <>
            ...
            <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                <li className=" list-pc"><span className=" font-medium">M.tech Scholar</span> in <span className=" font-medium">Information Security</span>, and B.Tech CSE Graduate. I've gained experience of 1+ year in Cyber Security at <u className=' cursor-pointer '> <a href="https://www.mcyberacademy.com" target={"_blank"}>M Cyber Academy</a> </u>, and now I'm looking forward for full-time VAPT engineer roles! ( Hit me up <a className='text-underline' href='mailto:lalitrohilla2005@gmail.com'><u>@lalitrohilla2005@gmail.com</u></a> :) )</li>
                <li className=" mt-3 list-building"> I enjoy exploring vulnerabilities in web applications, automating security tasks, and contributing to safer digital systems.</li>
